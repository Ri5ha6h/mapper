...
**Creates:** `components/mapper/tree-node.tsx`

**Depends on:** Phase 02 (types), Phase 04 (context), dnd-kit

---

## Overview

Recursive tree node component with drag/drop, expand/collapse, type icons.
...
- Mapped nodes: subtle green background
- Drop target: ring highlight when dragging over
...
- [x] Chevron shows only for nodes with children
- [x] Click chevron toggles expand
- [x] Source nodes are draggable
- [x] Target nodes are droppable
- [x] Hover highlight on drop target
- [x] Mapped nodes visually distinguished
- [x] Values truncated properly
